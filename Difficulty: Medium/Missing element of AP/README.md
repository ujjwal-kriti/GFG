<h2><a href="https://www.geeksforgeeks.org/problems/missing-element-of-ap2228/1?sortBy=submissions&category%255B%255D=Arrays&page=2&difficulty%255B%255D=0&status%255B%255D=solved">Missing element of AP</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a sorted array <strong>arr[] </strong>that represents an <strong>Arithmetic Progression</strong> (AP) with exactly <strong>one</strong> missing element, find the missing number.<br>The array <strong>arr[]</strong> is sorted in either ascending or descending order.</span></p>
